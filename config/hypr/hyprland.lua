...
hl.bind(mainMod .. " + M",      hl.dsp.exec_cmd("pkill -SIGTERM Hyprland"))
...
-- Next/previous workspace with mainMod + ./;
hl.bind(mainMod .. " + period",    hl.dsp.focus({ workspace = "e+1" }))
hl.bind(mainMod .. " + semicolon", hl.dsp.focus({ workspace = "e-1" }))
...
-- Lid switch: clamshell mode handling
...
-- Smart gaps: no gaps/border/rounding when a workspace has exactly one
-- tiled window; gaps return once a second window tiles alongside it.
